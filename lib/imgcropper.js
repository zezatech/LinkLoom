...
const Demo = ({ currentImage, croppedImg }) => {
  const [image, setImage] = useState(currentImage ? currentImage : defaultSrc);
  ...
  const getCropData = () => {
    if (typeof cropperRef.current?.cropper !== "undefined") {
      ...
      croppedImg(cropperRef.current?.cropper.getCroppedCanvas().toDataURL());
    }
  };
